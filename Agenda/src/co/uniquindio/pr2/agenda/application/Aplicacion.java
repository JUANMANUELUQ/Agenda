...
public class Aplicacion extends Application implements Serializable{
	...
	public boolean mostrarIngresoContacto(IngresoContactoOpciones accion) {
		try {
			...
			controller.setAgenda(agenda);
			switch (accion) {
				case ANIADIR_EXISTENTE_GRUPO: controller.organizarAniadirGrupo(); break;
				case ANIADIR_NUEVO_GRUPO: controller.organizarNuevoGrupo(); break;
				case ANIADIR_EXISTENTE_REUNION: controller.organizarAniadirReunion(); break;
	...
	/**
	 * Metodo que muestra la ventana donde se crea un grupo
	 * @return Si el grupo fue guardado o no
	 */
	...
	/**
	 * Metodo que muestra la ventana donde se crea una reunion
	 * @return Si la reunion fue guardada o no
	 */
	...
	/**
	 * Metodo que muestra la lista de los grupos de la agenda
