...
public class IngresoDatosContactoController {
	...
	private void boton() {
		...
		if ((opcion==IngresoContactoOpciones.ANIADIR || opcion==IngresoContactoOpciones.ANIADIR_NUEVO_GRUPO
		|| opcion==IngresoContactoOpciones.ANIADIR_NUEVO_REUNION) && sonDatosValidosAniadir()) {
			entradasValidas=true;
		} else if ((opcion==IngresoContactoOpciones.BUSCAR || opcion==IngresoContactoOpciones.ELIMINAR || opcion==IngresoContactoOpciones.ANIADIR_EXISTENTE_GRUPO
				|| opcion==IngresoContactoOpciones.ANIADIR_EXISTENTE_REUNION) && sonDatosValidos()) {
			entradasValidas=true;
		}
		if (entradasValidas) {
			JOptionPane.showConfirmDialog(null, "Funcion en construccion", "Funcion aun no completa", JOptionPane.WARNING_MESSAGE);
			switch (opcion) {
				case ANIADIR: aniadirContacto(); break;
				case BUSCAR: buscarContacto(); break;
				case ELIMINAR: eliminarContacto(); break;
				case ANIADIR_EXISTENTE_REUNION: aniadirReunion(); break;
				case ANIADIR_EXISTENTE_GRUPO: aniadirGrupo();  break;
	...
	/**
	 * Metodo que organiza la ventana para aniadir un contacto existente a un grupo
	 */
	public void organizarAniadirGrupo() {
		dialogStage.setTitle("A\u00F1adir contacto existente a grupo");
		opcion=IngresoContactoOpciones.ANIADIR_EXISTENTE_GRUPO;
	...
	/**
	 * Metodo que organiza la ventana para aniadir un contacto nuevo un grupo
	 */
	...
	/**
	 * Metodo que organiza la ventana para aniadir un contacto existente a una reunion
	 */
	public void organizarAniadirReunion() {
		dialogStage.setTitle("A\\u00F1adir contacto existente a reunion");
		opcion=IngresoContactoOpciones.ANIADIR_EXISTENTE_REUNION;
	...
	/**
	 * Metodo que organiza la ventana para aniadir un contacto nuevo a una reunion
	 */
	...
	/**
	 * Metodo que aniade un contacto existente a un grupo
	 */
	...
	/**
	 * Metodo que aniade un contacto nuevo a un grupo
	 */
	...
	/**
	 * Metodo que aniade un contacto existente a una reunion
	 */
	...
	/**
	 * Metodo que aniade un contacto nuevo a una reunion
	 */
	...
	/**
	 * Metodo que obtiene la reunion donde se va a guardar el contacto que se va a ingresar
	 * @param reunion Reunion donde se va a guardar el contacto
	 */
	...
	/**
	 * Metodo que obtiene el grupo donde se va a guardar el contacto que se va a ingresar
	 * @param grupo Grupo donde se va a guardar el contacto
	 */
